...
root = Tk()
root.title( "SkyScanner" )

def passenger():

    master = Tk()
    master.geometry("600x600")
    master.title( " Passenger Registration" )
    ...
    def deletePassenger():
        ...
        deletePass.title("Remove Passenger")
...
#Change seat number
    ...
    def deleteTicket():
        ...
        deleteTick.title("Tickets - Deletion")
...
def flight():
    ...
    def deleteFlight():
        ...
        deleteFli.title("Passenger - Registration")
